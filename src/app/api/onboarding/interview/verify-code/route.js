...
export async function POST(req) {
    try {
        ...
        // Notice: Time expiration checks are removed here.
        // This endpoint is used for registration signing up *after* the interview is passed.
        // Therefore, the interview date is inherently in the past. Time checks are handled in login/route.js.
